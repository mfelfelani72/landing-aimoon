                    ...
                    <div className='absolute top-[35rem] inset-x-0 width-theme rtl:mr-[20rem] ltr:ml-[20rem]'>
                        <div className="flex flex-col items-center justify-center mx-default">
                            ...
                            <div className="relative w-full">
                                ...
                                {/* coins-icon */}
                                <div className="absolute top-[11rem] right-[13rem] mx-default pointer-events-auto hover:animate-spin z-20">
                                    <ImageLazy src={coin_1} alt={"coin_1"} className={"w-8 h-8"} />
                                </div>
                                <div className="absolute top-[22rem] right-[3rem] mx-default pointer-events-auto hover:animate-spin z-20">
                                    <ImageLazy src={eth} alt={"eth"} className={"w-8 h-8"} />
                                </div>
                                <div className="absolute top-[14rem] left-[8.5rem] mx-default pointer-events-auto hover:animate-spin z-20">
                                    <ImageLazy src={usdt} alt={"usdt"} className={"w-10 h-10"} />
                                </div>
                                <div className="absolute top-[24rem] left-[2rem] mx-default pointer-events-auto hover:animate-spin z-20">
