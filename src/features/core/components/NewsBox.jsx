        ...
        <>
            <div className={cn("w-full h-full flex flex-col", className)}>
                ...
                <div className='relative mt-2'>
                    <ImageLazy src={pic} alt="pic" className={"w-full h-44 rounded-t-[1.25rem]"} />
                ...
                <div className='flex flex-col bg-[#28263a] rounded-b-[1.25rem] p-4'>
                    <div className="text-Neutral-100 text-base font-medium leading-snug">بیت‌کوین در آستانه سقوط یا جهش؟</div>
